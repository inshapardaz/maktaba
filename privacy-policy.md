...
This Privacy Policy describes how Maktaba ("the App," "we," "us," or "our") handles information when you use our e-book library management application.
...
- Provide the core functionality of the App (scanning, organizing, and syncing e-book files);
- Diagnose and fix technical issues, if diagnostics are enabled;
- Improve the App's features and stability.
...
The App is designed so that your e-book library data remains under your control on your own device and/or your own cloud storage account. While we take reasonable care in how the App is built, **we make no guarantee that the App is free of defects, security vulnerabilities, or data-handling errors**, and you use the App's storage and sync features at your own risk.

## 5. No Liability for Data Loss or Corruption

To the fullest extent permitted by applicable law, we disclaim any and all responsibility or liability for:
...
The App is not directed at children, and we do not knowingly collect information from children.
...
Questions about this Privacy Policy, please raise an issue on github repository.
