...
const en = {
  ...
  "librariesSettings.nawishtaSignedInAs": "Using your existing Nawishta sign-in",
...
const ur: TranslationDict = {
  ...
  "librariesSettings.nawishtaSignedInAs": "آپ کے موجودہ Nawishta سائن اِن کا استعمال ہو رہا ہے",
