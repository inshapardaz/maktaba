...
const en = {
  ...
  "duplicate.applyToAll": "Apply this action to all remaining duplicates",
  ...
  "importDialog.applyingToAll": "Applying '{action}' to all remaining duplicates",
  "importDialog.clearApplyToAll": "Change",
...
const ur: TranslationDict = {
  ...
  "duplicate.applyToAll": "یہ عمل باقی تمام ڈپلیکیٹس پر لاگو کریں",
  ...
  "importDialog.applyingToAll": "'{action}' تمام باقی ڈپلیکیٹس پر لاگو کیا جا رہا ہے",
  "importDialog.clearApplyToAll": "تبدیل کریں",
