...
const en = {
  ...
  "librariesSettings.s3Prefix": "Prefix (optional)",
  "librariesSettings.s3PrefixPlaceholder": "e.g. my-library",
  "librariesSettings.s3ServiceUrl": "Server URL (optional)",
  "librariesSettings.s3ServiceUrlDescription": "Leave blank for Amazon S3. Set this to use a compatible provider instead - MinIO, Backblaze B2, DigitalOcean Spaces, Cloudflare R2, a self-hosted server, etc.",
  "librariesSettings.s3ServiceUrlPlaceholder": "e.g. https://s3.example.com",
...
const ur: TranslationDict = {
  ...
  "librariesSettings.s3Prefix": "پریفکس (اختیاری)",
  "librariesSettings.s3PrefixPlaceholder": "مثلاً my-library",
  "librariesSettings.s3ServiceUrl": "سرور یو آر ایل (اختیاری)",
  "librariesSettings.s3ServiceUrlDescription": "Amazon S3 کے لیے خالی چھوڑ دیں۔ کسی متبادل مطابقت پذیر فراہم کنندہ (MinIO، Backblaze B2، DigitalOcean Spaces، Cloudflare R2، یا کسی سیلف ہوسٹڈ سرور) کے استعمال کے لیے یہ درج کریں۔",
  "librariesSettings.s3ServiceUrlPlaceholder": "مثلاً https://s3.example.com",
