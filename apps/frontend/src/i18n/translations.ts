...
const en = {
  ...
  "onboarding.step3Body": "Once your library is set up, drag EPUB, PDF, DOCX, or TXT files into the Maktaba window, or use the Add Books button in the toolbar, to add them.",
  ...
  "bookDetail.viewInGoogleDrive": "View in Google Drive",
  ...
  "analytics.totalBooks": "Books",
  "analytics.totalIssues": "Issues",
  "analytics.librarySize": "Library size",
  "analytics.totalAuthors": "Authors",
  "analytics.totalCollections": "Collections",
  "analytics.totalTags": "Tags",
  "analytics.totalSeries": "Series",
  "analytics.totalPeriodicals": "Periodicals",
  ...
  "bookDetail.pageCount": "{count} pages",
  ...
  "app.cloudReconnectTokenExpired": "Your sign-in for this library has expired or was revoked. Reconnect it from Settings → Libraries below.",
  "app.cloudReconnectUnreachable": "Couldn't reach the server for this library. Check your connection and try again.",
  ...
  "app.switchLockConflictTitle": "Library is open elsewhere",
  ...
  "settings.appTheme.white": "Plain",
  "settings.colorScheme": "Color scheme",
  "settings.accentColor": "Accent color",
  "settings.darkChrome": "Dark title bar and sidebar",
  ...
  "settings.sidebarExpandMode": "Sidebar sections",
  "settings.sidebarExpandModeSingle": "One at a time",
  "settings.sidebarExpandModeMultiple": "Multiple",
  "settings.sidebarExpandModeHint": "\"One at a time\" keeps a single sidebar section expanded, filling the available space. \"Multiple\" lets any number of sections be expanded, each capped to a max height with its own scrollbar.",
  ...
  "settings.docxReader": "DOCX reader",
  "settings.txtReader": "TXT reader",
  ...
  "librariesSettings.addLibraryWizardTitle": "Add library",
  "librariesSettings.typeLocal": "Local folder",
  "librariesSettings.typeLocalDescription": "Store your library on this computer's disk.",
  "librariesSettings.typeS3Description": "Amazon S3 or any S3-compatible storage (MinIO, Backblaze B2, DigitalOcean Spaces, ...).",
  "librariesSettings.typeGoogleDriveDescription": "Store your library in your Google Drive.",
  "librariesSettings.typeOneDriveDescription": "Store your library in your OneDrive.",
  "librariesSettings.typeNawishtaDescription": "Connect to a library hosted on your Nawishta account.",
  ...
  "librariesSettings.refreshCovers": "Refresh covers",
  ...
  "librariesSettings.reconnectDescription": "Supply this library's access key again - for example after rotating it with your storage provider, or if its saved credential is missing.",
  "librariesSettings.reconnectButton": "Reconnect",
  ...
  "librariesSettings.s3Region": "Region",
  "librariesSettings.s3Prefix": "Subfolder within the bucket (optional)",
  "librariesSettings.s3PrefixPlaceholder": "e.g. my-library",
  "librariesSettings.s3Endpoint": "Server endpoint (optional)",
  "librariesSettings.s3EndpointDescription": "Leave blank for Amazon S3. Set this to use a compatible provider instead - MinIO, Backblaze B2, DigitalOcean Spaces, Cloudflare R2, a self-hosted server, etc.",
  "librariesSettings.s3EndpointPlaceholder": "e.g. s3.example.com or play.min.io:9000",
  "librariesSettings.s3AccessKey": "Access key ID",
  "librariesSettings.s3SecretKey": "Secret access key",
  "librariesSettings.s3TestConnection": "Test connection",
  "librariesSettings.s3TestSuccess": "Connection successful.",
  "librariesSettings.s3Connect": "Connect",
  "librariesSettings.connectGoogleDrive": "Connect Google Drive…",
  "librariesSettings.googleDriveName": "Library name",
  "librariesSettings.googleDriveFolder": "Folder within Google Drive (optional)",
  "librariesSettings.googleDriveFolderPlaceholder": "e.g. Maktaba/My Library",
  "librariesSettings.googleDriveSignIn": "Sign in with Google",
  "librariesSettings.googleDriveSignedIn": "Signed in - ready to connect.",
  "librariesSettings.connectOneDrive": "Connect OneDrive…",
  "librariesSettings.oneDriveName": "Library name",
  "librariesSettings.oneDriveFolder": "Folder within OneDrive (optional)",
  "librariesSettings.oneDriveFolderPlaceholder": "e.g. Maktaba/My Library",
  "librariesSettings.oneDriveSignIn": "Sign in with Microsoft",
  "librariesSettings.oneDriveSignedIn": "Signed in - ready to connect.",
  "librariesSettings.connectNawishta": "Connect Nawishta library…",
  "librariesSettings.nawishtaEmail": "Email",
  "librariesSettings.nawishtaPassword": "Password",
  "librariesSettings.nawishtaPrivacyNote": "Maktaba does not store your email or password - only a temporary sign-in token, encrypted on this device.",
  "librariesSettings.nawishtaReusingCredential": "Reusing your existing Nawishta sign-in…",
  "librariesSettings.nawishtaSignedInAs": "Signed in as {who}",
  "librariesSettings.nawishtaLogout": "Log out",
  "librariesSettings.nawishtaSignIn": "Sign in",
  "librariesSettings.nawishtaSignInAgain": "Sign in again",
  "librariesSettings.nawishtaPickLibrary": "Choose a library",
  "librariesSettings.nawishtaSearchLibraries": "Search libraries…",
  "librariesSettings.nawishtaLoadingLibraries": "Loading libraries…",
  "librariesSettings.nawishtaNoLibrariesFound": "No libraries found.",
  "librariesSettings.nawishtaPrevPage": "Previous",
  "librariesSettings.nawishtaNextPage": "Next",
  "librariesSettings.nawishtaPageOf": "Page {page} of {pageCount}",
  "librariesSettings.nawishtaName": "Library name",

  "migrationWizard.title": "Migrate library to cloud",
  "migrationWizard.stepTarget": "Target",
  "migrationWizard.targetDescription": "Choose where to move this library's books and database to. Your current library is left untouched until the migration is verified and you confirm on the last step.",
  "migrationWizard.next": "Next",
  "migrationWizard.stepReview": "Review",
  "migrationWizard.counting": "Counting files…",
  "migrationWizard.fileCount": "{count} file(s) will be copied.",
  "migrationWizard.reviewWarning": "This can take a while depending on your library's size and connection speed. You can safely close this window - the migration keeps running in the background - and check back later.",
  "migrationWizard.back": "Back",
  "migrationWizard.startMigration": "Start migration",
  "migrationWizard.stepMigrate": "Migrate",
  "migrationWizard.progress": "{processed} of {total} file(s) copied",
  "migrationWizard.starting": "Starting…",
  "migrationWizard.failedTitle": "Migration failed",
  "migrationWizard.cancelledMessage": "Migration cancelled.",
  "migrationWizard.tryAgain": "Try again",
  "migrationWizard.cancel": "Cancel migration",
  "migrationWizard.stepFinish": "Finish",
  "migrationWizard.verifiedMessage": "Everything copied and verified successfully.",
  "migrationWizard.deleteSourceLabel": "Delete the original local copy",
  "migrationWizard.deleteSourceDescription": "Leave unchecked to keep it as a backup on this computer.",
  "migrationWizard.finish": "Finish",
  ...
  "importDialog.dropzoneTitle": "Drag EPUB/PDF/DOCX/TXT files or folders here",
  ...
  "importDialog.empty": "No files yet — drop EPUB/PDF/DOCX/TXT files above, or browse.",
  "importDialog.bulkMetadataToggle": "Common info for this batch",
  "importDialog.bulkMetadataHint": "Applied to every book imported in this batch. Authors, publisher, language, and series replace whatever was found in the file; tags and collections are added alongside it.",
  "importDialog.bulkMetadataUnset": "Leave as-is",
  ...
  "reader.downloading": "Downloading book…",
  "reader.downloadingWithPercent": "Downloading book… {percent}%",
...
const ur: TranslationDict = {
  ...
  "onboarding.step3Body": "لائبریری تیار ہونے کے بعد، EPUB، PDF، DOCX، یا TXT فائلیں مکتبہ کی ونڈو میں کھینچ لائیں، یا انہیں شامل کرنے کے لیے ٹول بار میں کتابیں شامل کریں بٹن استعمال کریں۔",
  ...
  "toolbar.maximize": "بڑا کریں",
  "toolbar.restore": "بحال کریں",
  "toolbar.closeWindow": "بند کریں",
  ...
  "bookDetail.viewInGoogleDrive": "Google Drive میں دیکھیں",
  ...
  "analytics.library": "لائبریری",
  "analytics.totalBooks": "کتابیں",
  "analytics.totalIssues": "شمارے",
  "analytics.librarySize": "لائبریری کا حجم",
  "analytics.totalAuthors": "مصنفین",
  "analytics.totalCollections": "مجموعے",
  "analytics.totalTags": "ٹیگز",
  "analytics.totalSeries": "سلسلے",
  "analytics.totalPeriodicals": "جرائد",
  "analytics.byFormat": "بلحاظ فارمیٹ",
  ...
  "bookDetail.pageCount": "{count} صفحات",
  ...
  "app.cloudReconnectTokenExpired": "اس لائبریری کے لیے آپ کا سائن ان ختم ہو گیا ہے یا منسوخ کر دیا گیا ہے۔ اسے نیچے سیٹنگز → لائبریریاں سے دوبارہ مربوط کریں۔",
  "app.cloudReconnectUnreachable": "اس لائبریری کے سرور تک رسائی نہیں ہو سکی۔ اپنا کنکشن چیک کریں اور دوبارہ کوشش کریں۔",
  ...
  "app.switchLockConflictTitle": "لائبریری کہیں اور کھلی ہے",
  ...
  "settings.appTheme.white": "سادہ",
  "settings.colorScheme": "رنگ سکیم",
  "settings.accentColor": "نمایاں رنگ",
  "settings.darkChrome": "گہرا ٹائٹل بار اور سائیڈ بار",
  "settings.accentColor.custom": "مرضی کا رنگ",
  ...
  "settings.sidebarExpandMode": "سائیڈ بار سیکشنز",
  "settings.sidebarExpandModeSingle": "ایک وقت میں ایک",
  "settings.sidebarExpandModeMultiple": "متعدد",
  "settings.sidebarExpandModeHint": "\"ایک وقت میں ایک\" صرف ایک سائیڈ بار سیکشن کھلا رکھتا ہے جو دستیاب جگہ کو بھرتا ہے۔ \"متعدد\" کسی بھی تعداد میں سیکشنز کو کھلا رکھنے دیتا ہے، ہر ایک اپنی زیادہ سے زیادہ اونچائی اور اپنے اسکرول بار کے ساتھ محدود ہوتا ہے۔",
  ...
  "settings.githubRepo": "گٹ ہب",
  "settings.privacyPolicy": "رازداری کی پالیسی",
  "settings.termsAndConditions": "شرائط و ضوابط",
  ...
  "settings.docxReader": "DOCX ریڈر",
  "settings.txtReader": "TXT ریڈر",
  ...
  "librariesSettings.addLibraryWizardTitle": "لائبریری شامل کریں",
  "librariesSettings.typeLocal": "مقامی فولڈر",
  "librariesSettings.typeLocalDescription": "اپنی لائبریری اس کمپیوٹر کی ڈسک پر محفوظ کریں۔",
  "librariesSettings.typeS3Description": "Amazon S3 یا کوئی بھی S3-compatible سٹوریج (MinIO، Backblaze B2، DigitalOcean Spaces وغیرہ)۔",
  "librariesSettings.typeGoogleDriveDescription": "اپنی لائبریری اپنے Google Drive میں محفوظ کریں۔",
  "librariesSettings.typeOneDriveDescription": "اپنی لائبریری اپنے OneDrive میں محفوظ کریں۔",
  "librariesSettings.typeNawishtaDescription": "اپنے Nawishta اکاؤنٹ پر میزبان کی گئی لائبریری سے جڑیں۔",
  ...
  "librariesSettings.refreshCovers": "سرورق تازہ کریں",
  ...
  "librariesSettings.reconnectDescription": "اس لائبریری کی رسائی کلید دوبارہ فراہم کریں - مثال کے طور پر اپنے سٹوریج فراہم کنندہ کے ساتھ اسے تبدیل کرنے کے بعد، یا اگر اس کی محفوظ شدہ کلید موجود نہیں ہے۔",
  "librariesSettings.reconnectButton": "دوبارہ مربوط کریں",
  ...
  "librariesSettings.s3Region": "خطہ (Region)",
  "librariesSettings.s3Prefix": "بکٹ کے اندر ذیلی فولڈر (اختیاری)",
  "librariesSettings.s3PrefixPlaceholder": "مثلاً my-library",
  "librariesSettings.s3Endpoint": "سرور اینڈ پوائنٹ (اختیاری)",
  "librariesSettings.s3EndpointDescription": "Amazon S3 کے لیے خالی چھوڑ دیں۔ کسی متبادل مطابقت پذیر فراہم کنندہ (MinIO، Backblaze B2، DigitalOcean Spaces، Cloudflare R2، یا کسی سیلف ہوسٹڈ سرور) کے استعمال کے لیے یہ درج کریں۔",
  "librariesSettings.s3EndpointPlaceholder": "مثلاً s3.example.com یا play.min.io:9000",
  "librariesSettings.s3AccessKey": "ایکسیس کی آئی ڈی",
  "librariesSettings.s3SecretKey": "خفیہ ایکسیس کی",
  "librariesSettings.s3TestConnection": "کنکشن کی جانچ کریں",
  "librariesSettings.s3TestSuccess": "کنکشن کامیاب رہا۔",
  "librariesSettings.s3Connect": "مربوط کریں",
  "librariesSettings.connectGoogleDrive": "Google Drive سے مربوط کریں…",
  "librariesSettings.googleDriveName": "لائبریری کا نام",
  "librariesSettings.googleDriveFolder": "Google Drive کے اندر فولڈر (اختیاری)",
  "librariesSettings.googleDriveFolderPlaceholder": "مثلاً Maktaba/My Library",
  "librariesSettings.googleDriveSignIn": "Google کے ساتھ سائن ان کریں",
  "librariesSettings.googleDriveSignedIn": "سائن ان ہو گیا - مربوط ہونے کے لیے تیار ہے۔",
  "librariesSettings.connectOneDrive": "OneDrive سے مربوط کریں…",
  "librariesSettings.oneDriveName": "لائبریری کا نام",
  "librariesSettings.oneDriveFolder": "OneDrive کے اندر فولڈر (اختیاری)",
  "librariesSettings.oneDriveFolderPlaceholder": "مثلاً Maktaba/My Library",
  "librariesSettings.oneDriveSignIn": "Microsoft کے ساتھ سائن ان کریں",
  "librariesSettings.oneDriveSignedIn": "سائن ان ہو گیا - مربوط ہونے کے لیے تیار ہے۔",
  "librariesSettings.connectNawishta": "Nawishta لائبریری سے مربوط کریں…",
  "librariesSettings.nawishtaEmail": "ای میل",
  "librariesSettings.nawishtaPassword": "پاس ورڈ",
  "librariesSettings.nawishtaPrivacyNote": "Maktaba آپ کا ای میل یا پاس ورڈ محفوظ نہیں کرتا - صرف ایک عارضی سائن اِن ٹوکن، جو اسی ڈیوائس پر خفیہ کر کے رکھا جاتا ہے۔",
  "librariesSettings.nawishtaReusingCredential": "آپ کے موجودہ Nawishta سائن اِن کو دوبارہ استعمال کیا جا رہا ہے…",
  "librariesSettings.nawishtaSignedInAs": "بطور {who} سائن اِن ہیں",
  "librariesSettings.nawishtaLogout": "لاگ آؤٹ کریں",
  "librariesSettings.nawishtaSignIn": "سائن ان کریں",
  "librariesSettings.nawishtaSignInAgain": "دوبارہ سائن ان کریں",
  "librariesSettings.nawishtaPickLibrary": "لائبریری منتخب کریں",
  "librariesSettings.nawishtaSearchLibraries": "لائبریریاں تلاش کریں…",
  "librariesSettings.nawishtaLoadingLibraries": "لائبریریاں لوڈ ہو رہی ہیں…",
  "librariesSettings.nawishtaNoLibrariesFound": "کوئی لائبریری نہیں ملی۔",
  "librariesSettings.nawishtaPrevPage": "پچھلا",
  "librariesSettings.nawishtaNextPage": "اگلا",
  "librariesSettings.nawishtaPageOf": "صفحہ {page} از {pageCount}",
  "librariesSettings.nawishtaName": "لائبریری کا نام",

  "migrationWizard.title": "لائبریری کو کلاؤڈ میں منتقل کریں",
  "migrationWizard.stepTarget": "ہدف",
  "migrationWizard.targetDescription": "منتخب کریں کہ اس لائبریری کی کتابیں اور ڈیٹا بیس کہاں منتقل کی جائیں۔ آپ کی موجودہ لائبریری اس وقت تک نہیں چھیڑی جاتی جب تک منتقلی کی تصدیق نہ ہو جائے اور آپ آخری مرحلے پر عزم نہ کریں۔",
  "migrationWizard.next": "اگلا",
  "migrationWizard.stepReview": "جائزہ",
  "migrationWizard.counting": "فائلیں گنی جا رہی ہیں…",
  "migrationWizard.fileCount": "{count} فائل(یں) کاپی کی جائیں گی۔",
  "migrationWizard.reviewWarning": "آپ کی لائبریری کے حجم اور کنکشن کی رفتار کے مطابق اس میں کچھ وقت لگ سکتا ہے۔ آپ یہ ونڈو محفوظ طریقے سے بند کر سکتے ہیں — منتقلی پس منظر میں جاری رہتی ہے — اور بعد میں واپس آ کر دیکھ سکتے ہیں۔",
  "migrationWizard.back": "واپس",
  "migrationWizard.startMigration": "منتقلی شروع کریں",
  "migrationWizard.stepMigrate": "منتقلی",
  "migrationWizard.progress": "{total} میں سے {processed} فائل(یں) کاپی ہوئیں",
  "migrationWizard.starting": "شروع ہو رہا ہے…",
  "migrationWizard.failedTitle": "منتقلی ناکام ہوئی",
  "migrationWizard.cancelledMessage": "منتقلی منسوخ کر دی گئی۔",
  "migrationWizard.tryAgain": "دوبارہ کوشش کریں",
  "migrationWizard.cancel": "منتقلی منسوخ کریں",
  "migrationWizard.stepFinish": "تکمیل",
  "migrationWizard.verifiedMessage": "سب کچھ کامیابی سے کاپی اور تصدیق ہو گیا۔",
  "migrationWizard.deleteSourceLabel": "اصل مقامی کاپی حذف کریں",
  "migrationWizard.deleteSourceDescription": "اسے اس کمپیوٹر پر بیک اپ کے طور پر رکھنے کے لیے غیر منتخب چھوڑ دیں۔",
  "migrationWizard.finish": "تکمیل",
  ...
  "importDialog.dropzoneTitle": "EPUB/PDF/DOCX/TXT فائلیں یا فولڈرز یہاں گھسیٹ لائیں",
  ...
  "importDialog.empty": "ابھی کوئی فائل نہیں — اوپر EPUB/PDF/DOCX/TXT فائلیں گھسیٹیں، یا منتخب کریں۔",
  "importDialog.bulkMetadataToggle": "اس بیچ کے لیے مشترکہ معلومات",
  "importDialog.bulkMetadataHint": "اس بیچ میں درآمد کی جانے والی ہر کتاب پر لاگو ہوتا ہے۔ مصنفین، پبلشر، زبان، اور سیریز فائل میں موجود معلومات کی جگہ لے لیتے ہیں؛ ٹیگز اور مجموعے اس کے ساتھ شامل کیے جاتے ہیں۔",
  "importDialog.bulkMetadataUnset": "جیسا ہے ویسا رہنے دیں",
  ...
  "reader.downloading": "کتاب ڈاؤن لوڈ ہو رہی ہے…",
  "reader.downloadingWithPercent": "کتاب ڈاؤن لوڈ ہو رہی ہے… {percent}%",
