...
S3-مطابقت بکٹ، آپ کا اپنا Google Drive، یا آپ کا اپنا OneDrive، جو ایک سے زیادہ کمپیوٹرز سے رسائی
حاصل کر سکتی ہے۔ کوئی لائبریری مربوط کرنے، اسے ہم آہنگ رکھنے، موجودہ مقامی لائبریری کو کلاؤڈ میں
منتقل کرنے، اور کنکشن کے مسئلے سے بحال ہونے کے طریقے کے لیے
[کلاؤڈ اسٹوریج](./cloud-storage) دیکھیں۔
