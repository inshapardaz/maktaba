...
![Screenshot: the welcome screen shown on first launch, before any library is set up](../screenshots/gs-welcome.png)
...
![Screenshot: the "Choose Library Folder" dialog and button](../screenshots/gs-choose-library.png)
...
![Screenshot: the main library view with several books and the sidebar visible](../screenshots/gs-home-view.png)
