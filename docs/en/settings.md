...
- **General** — app language (English/Urdu), accent color, and general preferences.
...
- **Reading** — default reading theme, text size, and Urdu font, used whenever you open a book.
...
- **Import** — preferences for how new books are added to your library.
- **About** — the version of Maktaba you're running, and whether an update is available.
- **Help** — this documentation, packaged right into the app, plus a way to replay the
