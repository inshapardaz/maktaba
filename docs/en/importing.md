...
![Screenshot: the Import dialog listing several books detected and ready to be added, each with its detected title/author/cover](../screenshots/import-dialog.png)

4. Review the list, then click **Import** to add them to your library.

![Screenshot: import in progress, with a progress indicator and a completed/successful result](../screenshots/import-progress.png)
